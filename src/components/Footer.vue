    ...
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
        ...
        <div class="mb-6 md:mb-0">
          <img src="@/assets/images/logo.png" alt="Nhamey" class="h-10 md:h-12 mb-3 md:mb-4" />
        ...
        <div class="mb-6 md:mb-0">
          ...
          <ul class="space-y-2">
            <li>
              <router-link
                to="/"
                class="text-gray-400 hover:text-primary transition-colors duration-200 inline-block"
              >
                Home
              </router-link>
            </li>
        ...
        <div class="mb-6 md:mb-0">
          ...
          <ul class="space-y-3">
            <li class="flex items-start text-gray-400">
              <el-icon class="mr-2 mt-1 flex-shrink-0"><Location /></el-icon>
        ...
        <!-- Social Media -->
        <div>
          <h3 class="text-lg font-semibold mb-3 md:mb-4">Follow Us</h3>
          <div class="flex space-x-5">
            <a href="#" class="text-gray-400 hover:text-primary transition-colors duration-200">
              <el-icon class="text-xl"><IconFacebook /></el-icon>
            </a>
            <a href="#" class="text-gray-400 hover:text-primary transition-colors duration-200">
              <el-icon class="text-xl"><IconInstagram /></el-icon>
            </a>
            <a href="#" class="text-gray-400 hover:text-primary transition-colors duration-200">
              <el-icon class="text-xl"><IconTwitter /></el-icon>
            </a>
          </div>
        </div>
      </div>
      ...
      <!-- Copyright -->
      <div
        class="border-t border-gray-700 mt-6 md:mt-8 pt-6 md:pt-8 text-center text-gray-400 text-sm"
      >
        <p>&copy; {{ new Date().getFullYear() }} Nhamey. All rights reserved.</p>
      </div>
    </div>
  </footer>
</template>
