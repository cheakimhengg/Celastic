        ...
        <div>
          <el-form :model="registerForm" :rules="rules" ref="registerFormRef" @submit.prevent="handleRegister">
            <el-form-item prop="email">
              ...
              <el-input v-model="registerForm.email" placeholder="Enter your email" :prefix-icon="User" size="large"
                class="rounded-lg" />
            </el-form-item>

            <el-form-item prop="username">
              <label class="block text-sm font-medium text-gray-700 mb-1">Username</label>
              <el-input v-model="registerForm.username" placeholder="Enter your username" :prefix-icon="User"
            ...
            <el-form-item prop="confirmPassword">
              ...
              <el-input v-model="registerForm.confirmPassword" type="password" placeholder="Enter your password"
                :prefix-icon="Lock" size="large" class="rounded-lg" show-password />
            </el-form-item>
...
const { isLoading, handleRegister, registerForm, registerFormRef, rules } = useRegister();
</script>
